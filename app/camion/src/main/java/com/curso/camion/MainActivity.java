...
import com.curso.camion.AdminConfiguracion;
import com.curso.camion.LoginActivity;
import com.curso.camion.MapsActivity;
import com.curso.camion.SettingsActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.curso.camion.R.layout.activity_main);

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();

        textViewWelcomeMessage = findViewById(com.curso.camion.R.id.textViewWelcomeMessage);
        buttonLogout = findViewById(com.curso.camion.R.id.buttonLogout);
        ...
        textViewAvisos = findViewById(com.curso.camion.R.id.textViewAvisos);
        textViewHorarios = findViewById(com.curso.camion.R.id.textViewHorarios);

        // Inicialización de listViewHorarios
        listViewHorarios = findViewById(com.curso.camion.R.id.listViewHorarios);
    ...
    private void showLogoutDialog() {
        ...
        builder.setTitle("Cerrar sesión")
                ...
                .setPositiveButton("Aceptar", (dialog, which) -> {
                    mAuth.signOut();
                    Intent intent = new Intent(com.curso.camion.MainActivity.this, LoginActivity.class);
    ...
    private void goToMap() {
        Intent intent = new Intent(com.curso.camion.MainActivity.this, MapsActivity.class);
        startActivity(intent);
    }

    private void goToSettings() {
        Intent intent = new Intent(com.curso.camion.MainActivity.this, SettingsActivity.class);
        startActivity(intent);
    }
