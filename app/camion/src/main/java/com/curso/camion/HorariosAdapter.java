...
public class HorariosAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textViewDia = convertView.findViewById(com.curso.camion.R.id.textViewDia);
        EditText editTextHorario = convertView.findViewById(com.curso.camion.R.id.editTextHorario);
